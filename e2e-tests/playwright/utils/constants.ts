...
/** GitHub repo used for sample catalog imports in E2E tests. */
export const RHDH_DEMO_CATALOG_REPO = `${JANUS_ORG}/backstage-showcase`;
/** @deprecated Use RHDH_DEMO_CATALOG_REPO instead. */
export const SHOWCASE_REPO = RHDH_DEMO_CATALOG_REPO;
