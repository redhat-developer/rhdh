...
export function enableOIDCLoginWithIngestion(actions: AuthConfigActions): void {
  ...
  actions.setDynamicPluginEnabled(
    "oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-community-plugin-catalog-backend-module-keycloak:{{inherit}}",
    true,
  );
...
export function enableLDAPLoginWithIngestion(actions: AuthConfigActions): void {
  ...
  actions.setDynamicPluginEnabled(
    "oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-plugin-catalog-backend-module-ldap:{{inherit}}",
    true,
  );
  actions.setAppConfigProperty("catalog.providers", {
    ldapOrg: {
...
export function enableMicrosoftLoginWithIngestion(actions: AuthConfigActions): void {
  ...
  actions.setDynamicPluginEnabled(
    "oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-plugin-catalog-backend-module-msgraph:{{inherit}}",
    true,
  );
  actions.setAppConfigProperty("catalog.providers", {
    microsoftGraphOrg: {
...
export function enableGithubLoginWithIngestion(actions: AuthConfigActions): void {
  ...
  actions.setDynamicPluginEnabled(
    "oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-plugin-catalog-backend-module-github-org:{{inherit}}",
    true,
  );
...
export function enableGitlabLoginWithIngestion(actions: AuthConfigActions): void {
  ...
  actions.setDynamicPluginEnabled(
    "oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-plugin-catalog-backend-module-gitlab-org:{{inherit}}",
    true,
  );
