...
guestTest.describe.skip("Test Keycloak plugin", () => {
  ...
  guestTest(
    "Users on keycloak should match users on backstage",
    async ({ page, uiHelper }) => {
...
guestTest.describe("Test Keycloak plugin metrics", () => {
  guestTest.fixme(
  ...
  guestTest("Test keycloak metrics with failure counters", async () => {
