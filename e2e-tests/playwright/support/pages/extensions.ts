...
export class Extensions {
  ...
  private commonHeadings = ["Versions", "Author", "Tags", "Category", "Publisher", "Support Provider"];
  private tableHeaders = ["Package name", "Version", "Role", "Backstage compatibility version", "Status"];
