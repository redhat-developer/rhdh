...
When contributing a new `@internal` plugin into this repo, you must remember to add the plugin to the [Containerfile](docker/Dockerfile) under the section titled `Stage 2 - Install dependencies`:
