...
To include components provided by other dynamic plugins inside static JSX as element children with your dynamically imported component, you can extract them from dynamicConfigs that is passed to the `staticJSXContent`:
