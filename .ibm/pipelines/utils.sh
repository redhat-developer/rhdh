...
install_crunchy_postgres_operator(){
  install_subscription postgresql openshift-operators postgresql v5 certified-operators
  check_operator_status 300 "openshift-operators" "Postgres for Kubernetes" "Succeeded"
}
