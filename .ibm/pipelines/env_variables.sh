...
K8S_CLUSTER_TOKEN_ENCODED=$(printf "%s" $K8S_CLUSTER_TOKEN_TEMPORARY | base64 | tr -d '\n')
...
K8S_CLUSTER_API_SERVER_URL=$(printf "%s" "https://api.alxdq5slv4a572c9df.eastus.aroapp.io:6443" | base64 | tr -d '\n')
K8S_SERVICE_ACCOUNT_TOKEN=$K8S_CLUSTER_TOKEN_ENCODED
OCM_CLUSTER_URL=$(printf "%s" "https://api.alxdq5slv4a572c9df.eastus.aroapp.io:6443" | base64 | tr -d '\n')
