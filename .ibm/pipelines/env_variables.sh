...
GITHUB_APP_APP_ID_AKS=$(cat /tmp/secrets/GITHUB_APP_APP_ID_AKS)
GITHUB_APP_CLIENT_ID_AKS=$(cat /tmp/secrets/GITHUB_APP_CLIENT_ID_AKS)
GITHUB_APP_PRIVATE_KEY_AKS=$(cat /tmp/secrets/GITHUB_APP_PRIVATE_KEY_AKS)
GITHUB_APP_CLIENT_SECRET_AKS=$(cat /tmp/secrets/GITHUB_APP_CLIENT_SECRET_AKS)

GITHUB_APP_APP_ID_EKS=$(cat /tmp/secrets/GITHUB_APP_APP_ID_EKS)
GITHUB_APP_CLIENT_ID_EKS=$(cat /tmp/secrets/GITHUB_APP_CLIENT_ID_EKS)
GITHUB_APP_PRIVATE_KEY_EKS=$(cat /tmp/secrets/GITHUB_APP_PRIVATE_KEY_EKS)
GITHUB_APP_CLIENT_SECRET_EKS=$(cat /tmp/secrets/GITHUB_APP_CLIENT_SECRET_EKS)

GITHUB_APP_APP_ID_GKE=$(cat /tmp/secrets/GITHUB_APP_APP_ID_GKE)
GITHUB_APP_CLIENT_ID_GKE=$(cat /tmp/secrets/GITHUB_APP_CLIENT_ID_GKE)
GITHUB_APP_PRIVATE_KEY_GKE=$(cat /tmp/secrets/GITHUB_APP_PRIVATE_KEY_GKE)
GITHUB_APP_CLIENT_SECRET_GKE=$(cat /tmp/secrets/GITHUB_APP_CLIENT_SECRET_GKE)

GITHUB_APP_APP_ID_HELM=$(cat /tmp/secrets/GITHUB_APP_APP_ID_HELM)
GITHUB_APP_CLIENT_ID_HELM=$(cat /tmp/secrets/GITHUB_APP_CLIENT_ID_HELM)
GITHUB_APP_PRIVATE_KEY_HELM=$(cat /tmp/secrets/GITHUB_APP_PRIVATE_KEY_HELM)
GITHUB_APP_CLIENT_SECRET_HELM=$(cat /tmp/secrets/GITHUB_APP_CLIENT_SECRET_HELM)

GITHUB_APP_APP_ID_OPERATOR=$(cat /tmp/secrets/GITHUB_APP_APP_ID_OPERATOR)
GITHUB_APP_CLIENT_ID_OPERATOR=$(cat /tmp/secrets/GITHUB_APP_CLIENT_ID_OPERATOR)
GITHUB_APP_PRIVATE_KEY_OPERATOR=$(cat /tmp/secrets/GITHUB_APP_PRIVATE_KEY_OPERATOR)
GITHUB_APP_CLIENT_SECRET_OPERATOR=$(cat /tmp/secrets/GITHUB_APP_CLIENT_SECRET_OPERATOR)

GITHUB_APP_APP_ID_OSD=$(cat /tmp/secrets/GITHUB_APP_APP_ID_OSD)
GITHUB_APP_CLIENT_ID_OSD=$(cat /tmp/secrets/GITHUB_APP_CLIENT_ID_OSD)
GITHUB_APP_PRIVATE_KEY_OSD=$(cat /tmp/secrets/GITHUB_APP_PRIVATE_KEY_OSD)
GITHUB_APP_CLIENT_SECRET_OSD=$(cat /tmp/secrets/GITHUB_APP_CLIENT_SECRET_OSD)

GITHUB_APP_APP_ID_HELM_PR=$(cat /tmp/secrets/GITHUB_APP_APP_ID_HELM_PR)
GITHUB_APP_CLIENT_ID_HELM_PR=$(cat /tmp/secrets/GITHUB_APP_CLIENT_ID_HELM_PR)
GITHUB_APP_PRIVATE_KEY_HELM_PR=$(cat /tmp/secrets/GITHUB_APP_PRIVATE_KEY_HELM_PR)
GITHUB_APP_CLIENT_SECRET_HELM_PR=$(cat /tmp/secrets/GITHUB_APP_CLIENT_SECRET_HELM_PR)

GITHUB_APP_APP_ID_HELM_PR_2=$(cat /tmp/secrets/GITHUB_APP_APP_ID_HELM_PR_2)
GITHUB_APP_CLIENT_ID_HELM_PR_2=$(cat /tmp/secrets/GITHUB_APP_CLIENT_ID_HELM_PR_2)
GITHUB_APP_PRIVATE_KEY_HELM_PR_2=$(cat /tmp/secrets/GITHUB_APP_PRIVATE_KEY_HELM_PR_2)
GITHUB_APP_CLIENT_SECRET_HELM_PR_2=$(cat /tmp/secrets/GITHUB_APP_CLIENT_SECRET_HELM_PR_2)

GITHUB_APP_APP_ID_HELM_PR_3=$(cat /tmp/secrets/GITHUB_APP_APP_ID_HELM_PR_3)
GITHUB_APP_CLIENT_ID_HELM_PR_3=$(cat /tmp/secrets/GITHUB_APP_CLIENT_ID_HELM_PR_3)
GITHUB_APP_PRIVATE_KEY_HELM_PR_3=$(cat /tmp/secrets/GITHUB_APP_PRIVATE_KEY_HELM_PR_3)
GITHUB_APP_CLIENT_SECRET_HELM_PR_3=$(cat /tmp/secrets/GITHUB_APP_CLIENT_SECRET_HELM_PR_3)
