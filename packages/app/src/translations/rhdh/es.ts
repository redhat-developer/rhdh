...
export default createTranslationMessages({
  ...
  messages: {
    ...
    'app.entityPage.overview.title': 'Resumen',
    'app.entityPage.topology.title': 'Topología',
    'app.entityPage.issues.title': 'Problemas',
    ...
    'app.entityPage.monitoring.title': 'Monitoreo',
    'app.entityPage.lighthouse.title': 'Lighthouse',
    'app.entityPage.api.title': 'API',
    'app.entityPage.dependencies.title': 'Dependencias',
    'app.entityPage.docs.title': 'Documentación',
    'app.entityPage.definition.title': 'Definición',
