...
export default createTranslationMessages({
  ...
  messages: {
    ...
    'app.entityPage.overview.title': 'Übersicht',
    'app.entityPage.topology.title': 'Topologie',
    'app.entityPage.issues.title': 'Issues',
    ...
    'app.entityPage.imageRegistry.title': 'Image Registry',
    'app.entityPage.monitoring.title': 'Überwachung',
    'app.entityPage.lighthouse.title': 'Lighthouse',
    'app.entityPage.api.title': 'API',
    'app.entityPage.dependencies.title': 'Abhängigkeiten',
    'app.entityPage.docs.title': 'Dokumentation',
    'app.entityPage.definition.title': 'Definition',
    'app.entityPage.diagram.title': 'Systemdiagramm',
    'app.entityPage.workflows.title': 'Workflows',
