...
export default createTranslationMessages({
  ...
  messages: {
    ...
    'app.entityPage.overview.title': 'Aperçu',
    'app.entityPage.topology.title': 'Topologie',
    'app.entityPage.issues.title': 'Problèmes',
    ...
    'app.entityPage.imageRegistry.title': "Registre d'Images",
    'app.entityPage.monitoring.title': 'Surveillance',
    'app.entityPage.lighthouse.title': 'Lighthouse',
    'app.entityPage.api.title': 'API',
    'app.entityPage.dependencies.title': 'Dépendances',
    'app.entityPage.docs.title': 'Documentation',
    'app.entityPage.definition.title': 'Définition',
    'app.entityPage.diagram.title': 'Diagramme du Système',
    'app.entityPage.workflows.title': 'Flux de travail',
