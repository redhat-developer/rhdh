...
export default createTranslationMessages({
  ...
  messages: {
    ...
    'app.entityPage.overview.title': 'Panoramica',
    'app.entityPage.topology.title': 'Topologia',
    'app.entityPage.issues.title': 'Problemi',
    'app.entityPage.pullRequests.title': 'Pull/Merge Requests',
    'app.entityPage.ci.title': 'CI',
    'app.entityPage.cd.title': 'CD',
    'app.entityPage.kubernetes.title': 'Kubernetes',
    'app.entityPage.imageRegistry.title': 'Registro Immagini',
    'app.entityPage.monitoring.title': 'Monitoraggio',
    'app.entityPage.lighthouse.title': 'Lighthouse',
    'app.entityPage.api.title': 'API',
    'app.entityPage.dependencies.title': 'Dipendenze',
    'app.entityPage.docs.title': 'Documentazione',
    'app.entityPage.definition.title': 'Definizione',
    'app.entityPage.diagram.title': 'Diagramma del Sistema',
    'app.entityPage.workflows.title': 'Flussi di lavoro',
